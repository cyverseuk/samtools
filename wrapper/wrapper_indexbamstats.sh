...
OUTPUT=${OUTPUT%%.*}
CMDLINEARG="samtools index ${INPUTSU}; samtools idxstats ${INPUTSU} >> stats.txt"
...
cat /mnt/data/apps/index_bam_and_stats/lib/condorSubmit.htc >> lib/condorSubmitEdit.htc
